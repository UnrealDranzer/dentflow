...
import { validate, doctorSchema, doctorUpdateSchema } from '../middleware/validate.js';
...
router.put('/:id', authenticate, tenantGuard, subscriptionGuard, validate(doctorUpdateSchema), updateDoctor);
